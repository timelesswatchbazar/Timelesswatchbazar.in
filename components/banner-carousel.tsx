  ...
  return (
    <div className="banner-carousel content-reveal">
        ...
        {banners.map((banner) => (
          <div key={banner.src} className="banner-carousel-slide">
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/35 to-black/20 sm:bg-gradient-to-r sm:from-black/55 sm:via-black/25 sm:to-transparent" />
            <div className="absolute inset-0 flex items-end px-4 pb-10 sm:items-center sm:px-12 sm:pb-0 lg:px-16">
              <div className="max-w-xl text-white">
                <p className="text-[0.65rem] font-semibold uppercase tracking-[0.18em] text-white sm:text-sm sm:tracking-[0.2em]">
                ...
                <p className="mt-2 hidden max-w-md text-sm text-zinc-200 sm:mt-3 sm:block sm:text-base">
      ...
      <button
        ...
        className="absolute left-2 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-zinc-900 shadow transition hover:bg-white sm:left-5 sm:h-10 sm:w-10"
      ...
      <button
        ...
        className="absolute right-2 top-1/2 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-zinc-900 shadow transition hover:bg-white sm:right-5 sm:h-10 sm:w-10"
